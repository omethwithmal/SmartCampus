    ...
    switch (currentTheme) {
      case 'light':
        return {
          ...
          sidebar: 'bg-white/80 border-emerald-200 shadow-lg glass-card',
          sidebarText: 'text-emerald-700/60',
          card: 'bg-white/80 border-emerald-200 shadow-md glass-card',
          cardHover: 'hover:border-emerald-300 hover:scale-[1.02] hover:shadow-2xl transition-all duration-300',
          text: 'text-gray-800',
          textSecondary: 'text-emerald-600/70',
          border: 'border-emerald-200',
          input: 'bg-white border-emerald-300 text-gray-800 focus:ring-2 focus:ring-emerald-500/50 transition-shadow',
          buttonPrimary: 'bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white btn-shimmer',
          buttonSecondary: 'border-emerald-300 text-emerald-600 hover:bg-emerald-50 hover:shadow-lg',
          tableHeader: 'border-emerald-200 bg-emerald-50 text-emerald-700',
          tableRow: 'border-emerald-100 hover:bg-emerald-50 hover:scale-[1.01] hover:shadow-md transition-all rounded-xl mb-2',
          badgeAvailable: 'bg-emerald-100 text-emerald-700 shadow-sm',
          badgeBooked: 'bg-amber-100 text-amber-700 shadow-sm',
          badgeMaintenance: 'bg-rose-100 text-rose-700 shadow-sm',
          accent: 'emerald',
      ...
      case 'ocean':
        return {
          container: 'bg-[#020617]',
          sidebar: 'bg-[#0f172a]/80 border-blue-500/20 shadow-lg shadow-blue-900/20 glass-card',
          sidebarText: 'text-blue-300/60',
          card: 'bg-[#0f172a]/60 border-blue-500/20 glass-card',
          cardHover: 'hover:border-blue-500/50 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] transition-all duration-300',
          text: 'text-white',
          textSecondary: 'text-blue-300/50',
          border: 'border-blue-500/20',
          input: 'bg-black/30 border-blue-500/30 text-white focus:ring-2 focus:ring-blue-500/50 transition-shadow',
          buttonPrimary: 'bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white btn-shimmer',
          buttonSecondary: 'border-blue-500/30 text-blue-300/70 hover:bg-blue-500/10 hover:shadow-lg',
          tableHeader: 'border-blue-500/20 bg-blue-900/20 text-blue-300',
          tableRow: 'border-blue-500/10 hover:bg-blue-500/10 hover:scale-[1.01] hover:border-blue-500/30 transition-all rounded-xl mb-2',
          badgeAvailable: 'bg-blue-500/20 text-blue-400 shadow-[0_0_10px_rgba(59,130,246,0.2)]',
          badgeBooked: 'bg-amber-500/20 text-amber-400 shadow-[0_0_10px_rgba(245,158,11,0.2)]',
          badgeMaintenance: 'bg-rose-500/20 text-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.2)]',
          accent: 'blue',
      ...
      case 'sunset':
        return {
          container: 'bg-[#1a0b02]',
          sidebar: 'bg-[#2a1304]/80 border-orange-500/20 shadow-lg shadow-orange-900/20 glass-card',
          sidebarText: 'text-orange-300/60',
          card: 'bg-[#2a1304]/60 border-orange-500/20 glass-card',
          cardHover: 'hover:border-orange-500/50 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(249,115,22,0.15)] transition-all duration-300',
          text: 'text-white',
          textSecondary: 'text-orange-300/50',
          border: 'border-orange-500/20',
          input: 'bg-black/30 border-orange-500/30 text-white focus:ring-2 focus:ring-orange-500/50 transition-shadow',
          buttonPrimary: 'bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white btn-shimmer',
          buttonSecondary: 'border-orange-500/30 text-orange-300/70 hover:bg-orange-500/10 hover:shadow-lg',
          tableHeader: 'border-orange-500/20 bg-orange-900/20 text-orange-300',
          tableRow: 'border-orange-500/10 hover:bg-orange-500/10 hover:scale-[1.01] hover:border-orange-500/30 transition-all rounded-xl mb-2',
          badgeAvailable: 'bg-orange-500/20 text-orange-400 shadow-[0_0_10px_rgba(249,115,22,0.2)]',
          badgeBooked: 'bg-amber-500/20 text-amber-400 shadow-[0_0_10px_rgba(245,158,11,0.2)]',
          badgeMaintenance: 'bg-rose-500/20 text-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.2)]',
          accent: 'orange',
      ...
      case 'purple':
        return {
          container: 'bg-[#0f0728]',
          sidebar: 'bg-[#1c0f3d]/80 border-purple-500/20 shadow-lg shadow-purple-900/20 glass-card',
          sidebarText: 'text-purple-300/60',
          card: 'bg-[#1c0f3d]/60 border-purple-500/20 glass-card',
          cardHover: 'hover:border-purple-500/50 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(168,85,247,0.15)] transition-all duration-300',
          text: 'text-white',
          textSecondary: 'text-purple-300/50',
          border: 'border-purple-500/20',
          input: 'bg-black/30 border-purple-500/30 text-white focus:ring-2 focus:ring-purple-500/50 transition-shadow',
          buttonPrimary: 'bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-500 hover:to-fuchsia-500 text-white btn-shimmer',
          buttonSecondary: 'border-purple-500/30 text-purple-300/70 hover:bg-purple-500/10 hover:shadow-lg',
          tableHeader: 'border-purple-500/20 bg-purple-900/20 text-purple-300',
          tableRow: 'border-purple-500/10 hover:bg-purple-500/10 hover:scale-[1.01] hover:border-purple-500/30 transition-all rounded-xl mb-2',
          badgeAvailable: 'bg-purple-500/20 text-purple-400 shadow-[0_0_10px_rgba(168,85,247,0.2)]',
          badgeBooked: 'bg-amber-500/20 text-amber-400 shadow-[0_0_10px_rgba(245,158,11,0.2)]',
          badgeMaintenance: 'bg-rose-500/20 text-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.2)]',
          accent: 'purple',
      ...
      default:
        return {
          container: 'bg-[#020b08]',
          sidebar: 'bg-[#041915]/80 border-emerald-500/20 shadow-lg shadow-emerald-900/20 glass-card',
          sidebarText: 'text-emerald-300/60',
          card: 'bg-[#041915]/60 border-emerald-500/20 glass-card',
          cardHover: 'hover:border-emerald-500/50 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(16,185,129,0.15)] transition-all duration-300',
          text: 'text-white',
          textSecondary: 'text-emerald-300/50',
          border: 'border-emerald-500/20',
          input: 'bg-black/30 border-emerald-500/30 text-white focus:ring-2 focus:ring-emerald-500/50 transition-shadow',
          buttonPrimary: 'bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 text-white btn-shimmer',
          buttonSecondary: 'border-emerald-500/30 text-emerald-300/70 hover:bg-emerald-500/10 hover:shadow-lg',
          tableHeader: 'border-emerald-500/20 bg-emerald-900/20 text-emerald-300',
          tableRow: 'border-emerald-500/10 hover:bg-emerald-500/10 hover:scale-[1.01] hover:border-emerald-500/30 transition-all rounded-xl mb-2',
          badgeAvailable: 'bg-emerald-500/20 text-emerald-400 shadow-[0_0_10px_rgba(16,185,129,0.2)]',
          badgeBooked: 'bg-amber-500/20 text-amber-400 shadow-[0_0_10px_rgba(245,158,11,0.2)]',
          badgeMaintenance: 'bg-rose-500/20 text-rose-400 shadow-[0_0_10px_rgba(244,63,94,0.2)]',
          accent: 'emerald',
    ...
    <div className={`flex min-h-screen transition-colors duration-300 ${themeClasses.container}`}>
      ...
      <main className="ml-80 flex-1 p-8">
        <div className="max-w-[1600px] mx-auto">
          {/* Header with Real-time Status and Theme Toggle */}
          <div className="flex justify-between items-start mb-8">
            <div>
              <h2 className={`text-3xl font-bold tracking-tight ${themeClasses.text}`}>Labs Analyze Dashboard</h2>
              <p className={`${themeClasses.textSecondary} mt-1 flex items-center gap-2`}>
            ...
            <div className="flex gap-3 items-center">
              ...
              <button
                ...
                className={`backdrop-blur-md rounded-2xl px-4 py-3 border transition-all ${themeClasses.card} ${themeClasses.cardHover} ${utilizationData.isRefreshing ? 'animate-spin' : ''}`}
              >
              ...
              <div className={`backdrop-blur-md rounded-2xl px-6 py-3 border ${themeClasses.card} ${themeClasses.cardHover}`}>
                ...
                <div className={`text-4xl font-bold ${themeClasses.accentColor} mt-1`}>{utilizationData.overallEfficiency}</div>
                <div className={`text-xs flex items-center justify-end gap-1 mt-1 ${themeClasses.accentColor} opacity-70`}>
                  <TrendingUp size={12} />
                  Real-time
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                {[
                  ...
                  <div key={idx} className={`backdrop-blur-md rounded-2xl p-5 border transition-all duration-300 group ${themeClasses.card} ${themeClasses.cardHover} animate-stagger-${idx + 1}`}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`text-2xl font-bold ${themeClasses.text}`}>{kpi.value}{kpi.suffix}</span>
                    </div>
              ...
              <div className={`backdrop-blur-md rounded-2xl border p-6 animate-stagger-5 ${themeClasses.card} ${themeClasses.cardHover}`}>
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className={`font-semibold ${themeClasses.text}`}>Real-time Lab Resource Utilization</h3>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className={themeClasses.textSecondary}>Lab Usage Rate</span>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className={themeClasses.textSecondary}>Computer Availability</span>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className={themeClasses.textSecondary}>Software License Usage</span>
                  ...
                  <div className="flex flex-col items-center">
                    <div className="relative w-32 h-32">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className={`font-bold text-xl ${themeClasses.text}`}>{utilizationData.overallEfficiency}%</span>
                      </div>
                    </div>
                ...
                <div className={`grid grid-cols-3 gap-4 mt-6 pt-6 border-t ${themeClasses.border}`}>
                  <div className="text-center">
                    <div className={`text-xs ${themeClasses.textSecondary}`}>Network Load</div>
                    <div className={`text-lg font-bold mt-1 ${themeClasses.text}`}>{utilizationData.networkLoad}%</div>
                  ...
                  <div className="text-center">
                    <div className={`text-xs ${themeClasses.textSecondary}`}>Power Consumption</div>
                    <div className={`text-lg font-bold mt-1 ${themeClasses.text}`}>{utilizationData.powerConsumption}%</div>
                    <div className="w-full h-1 bg-emerald-500/20 rounded-full mt-2">
                      <div className="h-full bg-amber-500 rounded-full" style={{ width: `${utilizationData.powerConsumption}%` }}></div>
                    </div>
                  </div>
                  <div className="text-center">
                    <div className={`text-xs ${themeClasses.textSecondary}`}>Response Time</div>
                    <div className={`text-lg font-bold mt-1 ${themeClasses.text}`}>{realtimeStatus.avgResponseTime}</div>
                    <div className={`text-xs ${themeClasses.textSecondary} mt-1`}>{realtimeStatus.networkHealth}</div>
                  </div>
                </div>
              </div>
              ...
              <div className={`backdrop-blur-md rounded-2xl border overflow-hidden ${themeClasses.card} ${themeClasses.cardHover}`}>
                <div className={`p-5 border-b ${themeClasses.border} flex items-center gap-2`}>
                  <Calendar className="text-emerald-400" size={18} />
                  <h3 className={`font-semibold ${themeClasses.text}`}>Lab Schedule</h3>
                </div>
            ...
            <div className="space-y-6">
              <div className="relative overflow-hidden bg-gradient-to-br from-black/60 to-black/90 rounded-2xl p-6 border animate-stagger-2 glass-card transition-all hover:scale-[1.01] hover:shadow-2xl" style={{ borderColor: 'rgba(var(--tw-colors-emerald-500), 0.3)' }}>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-white font-bold text-lg">AI Lab Assistant</h3>
                    <p className={`text-xs ${themeClasses.textSecondary}`}>Real-time monitoring • Active</p>
                  </div>
                </div>
                <p className={`text-sm leading-relaxed mb-4 ${themeClasses.textSecondary} text-white/80`}>
                  I'm monitoring <span className="font-bold text-white">{labs.length} labs</span> in real-time. Currently <span className="font-bold text-white">{realtimeStatus.activeLabs} labs</span> are active with <span className="font-bold text-white">{realtimeStatus.totalComputersOnline} computers</span> online.
              ...
              <div className={`backdrop-blur-md rounded-2xl border p-6 ${themeClasses.card} ${themeClasses.cardHover}`}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className={`font-semibold ${themeClasses.text}`}>Real-time Performance</h3>
                </div>
                <div className="space-y-4">
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className={`${themeClasses.textSecondary} text-sm`}>Computer Utilization</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className={`${themeClasses.textSecondary} text-sm`}>Software Compliance</span>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      <span className={`${themeClasses.textSecondary} text-sm`}>Network Health</span>
              ...
              <div className={`backdrop-blur-md rounded-2xl border p-6 ${themeClasses.card} ${themeClasses.cardHover}`}>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className={`font-semibold ${themeClasses.text}`}>Real-time Goals</h3>
                </div>
          ...
          <div className="mt-8">
            <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
              <div>
                <h3 className={`text-xl font-bold ${themeClasses.text}`}>Labs Management</h3>
                <p className={`${themeClasses.textSecondary} text-sm mt-1`}>Real-time lab monitoring and management</p>
              </div>
              <div className="flex gap-3">
                <button
                  onClick={downloadCSV}
                ...
                <div className={`p-6 border-b ${themeClasses.border} flex justify-between items-center bg-black/10`}>
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className={`text-lg font-semibold ${themeClasses.text}`}>
                      {editingLab ? 'Edit Lab Configuration' : 'Add New Lab Configuration'}
                    </h3>
                  </div>
                ...
                <div className="p-6 max-h-[70vh] overflow-y-auto scrollbar-hide">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Lab Name</label>
                        <input
                          type="text"
                          name="name"
                          value={formData.name}
                      ...
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Lab Category</label>
                        <select
                          name="labCategory"
                      ...
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Number of Computers</label>
                        <input
                          type="number"
                      ...
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Computer Specs</label>
                        <select
                          name="computerSpecs"
                      ...
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Internet Availability</label>
                        <select
                      ...
                      <div>
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Time Slots</label>
                        <input
                          type="text"
                          ...
                          className={`w-full rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-emerald-500 ${themeClasses.input}`}
                        />
                        <p className={`text-xs mt-1 ${themeClasses.textSecondary}`}>Separate multiple time slots with commas</p>
                      </div>
                      
                      {/* Image Upload */}
                      <div className="md:col-span-2">
                        <label className={`block text-sm font-medium mb-2 ${themeClasses.textSecondary}`}>Cover Image</label>
                      ...
                      <div className="md:col-span-2">
                        <label className={`block text-sm font-medium mb-3 ${themeClasses.textSecondary}`}>Equipment</label>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                          {['projector', 'smartBoard', 'printer', 'scanner'].map(equip => (
                            <label key={equip} className={`flex items-center gap-2 p-2 rounded-lg border cursor-pointer hover:bg-emerald-500/10 ${themeClasses.border}`}>
                              <input
                                type="checkbox"
                                name={equip}
                              ...
                              />
                              <span className={`text-sm ${themeClasses.textSecondary} capitalize`}>{equip}</span>
                            </label>
                          ))}
                        </div>
                      </div>
                      ...
                      {/* Operating Systems */}
                      <div className="md:col-span-2">
                        <label className={`block text-sm font-medium mb-3 ${themeClasses.textSecondary}`}>Operating Systems</label>
                        <div className="flex gap-4 flex-wrap">
                          {['Windows 11 Pro', 'Ubuntu 22.04 LTS', 'macOS Ventura'].map(os => (
                            <label key={os} className={`flex items-center gap-2 p-2 rounded-lg border cursor-pointer hover:bg-emerald-500/10 ${themeClasses.border}`}>
                              <input
                                type="checkbox"
                                ...
                                className="w-4 h-4 accent-emerald-500"
                              />
                              <span className={`text-sm ${themeClasses.textSecondary}`}>{os}</span>
                            </label>
                          ))}
                        </div>
                      </div>
                      ...
                      {/* Software Section */}
                      <div className="md:col-span-2">
                        <label className={`block text-sm font-medium mb-3 ${themeClasses.textSecondary}`}>Software & IDEs</label>
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead>
                    <tr className={`border-b ${themeClasses.tableHeader}`}>
                      ...
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Lab Name</th>
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Category</th>
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Location</th>
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Computers</th>
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Status</th>
                      <th className={`text-left py-4 px-6 ${themeClasses.textSecondary} font-medium text-sm`}>Real-time</th>
                  ...
                  <tbody>
                    {filteredLabs.map(lab => {
                      ...
                      }[lab.status] || 'bg-gray-100 text-gray-700' : statusBadge.bg;
                      
                      const statusTextClass = !isDarkTheme ? 
                        (lab.status === 'available' ? 'text-emerald-700' : lab.status === 'booked' ? 'text-amber-700' : 'text-rose-700') 
                        : statusBadge.text;
                      
                      return (
                        <tr key={lab.id} className={`border-b transition ${themeClasses.tableRow}`}>
                          ...
                          <td className="py-4 px-6">
                            <div>
                              <p className={`font-medium ${themeClasses.text}`}>{lab.name}</p>
                              <p className={`text-xs ${themeClasses.textSecondary} mt-0.5 line-clamp-1`}>{lab.description}</p>
                            </div>
                          </td>
                          <td className="py-4 px-6">
                          ...
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-1">
                              ...
                              <span className={`text-sm ${themeClasses.textSecondary}`}>{lab.onlineComputers || lab.equipment.numberOfComputers}/{lab.equipment.numberOfComputers}</span>
                            </div>
                          </td>
                          <td className="py-4 px-6">
                          ...
                          <td className="py-4 px-6">
                            <div className="flex flex-col gap-1">
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`text-xs ${themeClasses.textSecondary}`}>{lab.currentOccupancy || 0} active</span>
                              </div>
                ...
                {filteredLabs.length === 0 && (
                  <div className="text-center py-12">
                    <FlaskConical className={`mx-auto ${themeClasses.textSecondary}`} size={48} />
                    <p className={`${themeClasses.textSecondary} mt-2`}>No labs found. Click "Add Lab" to get started.</p>
                  </div>
                )}
              </div>
            </div>
